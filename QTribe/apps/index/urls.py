...
from index.views import HomePage,NoFindPage,Information,VideoMall, ArticleMall,LifeMall,OtherUser,StartIt,OtherDetails,FreeMovie
...
urlpatterns=[
    ...
    path('TV_home/',FreeMovie.as_view()),
    ...
    path('other_details/',OtherDetails.as_view()),
